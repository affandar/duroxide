...
pub use crate::provider_validation::cancellation::{
    ...
    test_renew_returns_terminal_when_orchestration_completed, test_same_activity_in_worker_items_and_cancelled_is_noop,
};
...
pub mod capability_filtering {
    pub use crate::provider_validation::capability_filtering::{
        ...
        test_fetch_filter_boundary_versions, test_fetch_filter_does_not_lock_skipped_instances,
        ...
        test_fetch_with_filter_none_returns_any_item, test_fetch_with_incompatible_filter_skips_item,
        test_filter_with_empty_supported_versions_returns_nothing, test_pinned_version_immutable_across_ack_cycles,
        test_pinned_version_stored_via_ack_metadata, test_provider_updates_pinned_version_when_told,
    };
}
