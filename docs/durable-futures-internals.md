...
This durable execution model was pioneered by AWS Simple Workflow Service over a decade ago, and has since been adopted by systems like Uber's Cadence and Temporal. Duroxide draws inspiration from these approaches.
