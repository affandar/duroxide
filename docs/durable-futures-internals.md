...
This durable execution model was pioneered by AWS Simple Workflow Service over a decade ago. Notable implementations include Microsoft's Durable Task Framework (.NET), Azure Durable Functions, Uber's Cadence, and Temporal. Duroxide brings this approach to Rust.
